//------------------------------------------------------------------------------
// <Enligh Fountian App. Code for this application was borrowed from the 
// Microsoft kinect sensor library>
//------------------------------------------------------------------------------
using System.IO;
...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// </summary>
        private DrawingImage imageSource;  /*image source is another way that the image element of the window
                                            can be accessed.  This is a little dangerous due to the fact that 
                                            it has higher precidence that the drawing context, or so it would 
                                            appear*/
        ...
        {
            /* Each one of these ifs below checks one of the edges of the image to see if the user has gone off screen */
                ...
                if (skeletons.Length != 0)
                {
                    foreach (Skeleton skel in skeletons)
                    {
                        ...
                        if (skel.TrackingState == SkeletonTrackingState.Tracked)
                        {
                            ...
                            //Console.WriteLine("Skeleton Was drawn");
                        }
